...
#define DEFAULT_SELECTION_INDICATOR_COLOR   colorTheme
...
- (id)initWithFrame:(CGRect)frame
{
    if (self = [super initWithFrame:frame]) {
        ...
        self.backgroundColor = UI_COLOR_FROM_RGB(0xecf0f1);
        self.selectionStyle = SMVerticalSegmentedControlSelectionStyleBox;
        self.selectionIndicatorThickness = 4;
    }
