...
+ (void)start {
    ...
    [self changeCacheCountLimit:INT_MAX costLimit:1024 * 1024 * 200 ageLimit:DBL_MAX freeDiskSpaceLimit:60];
}
...
- (void)startLoading
{
    ...
    if ([[[self.request URL] absoluteString] containsString:@".mp4"])
    {
