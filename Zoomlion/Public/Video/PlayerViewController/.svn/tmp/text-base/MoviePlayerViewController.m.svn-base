...
- (void)viewDidLoad {
    ...
    [self.backBtn setBackgroundImage:[UIImage imageNamed:@"nav_return_white"] forState:UIControlStateNormal];
    [self.backBtn addTarget:self action:@selector(zf_playerBackAction)];
